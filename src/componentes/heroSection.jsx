  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center w-full justify-center mt-20 mb-20 gap-44">
      <div className="flex flex-col items-center">
        ...
        <a href="https://apps.apple.com/us/app/instagram/id389801252" target="blank"><button className="bg-[#5B6CFF] hover:bg-[#439DFE] text-white font-bold py-2 px-4 rounded-full self-center mt-4 mb-20">¡Únete a la APP!</button></a>
